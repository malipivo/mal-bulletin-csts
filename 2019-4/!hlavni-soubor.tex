...
\usepackage[czech,english,slovak,ngerman]{babel}
...
\graphicspath{
   ...
   %{zdrojaky/rytir/obr/}
   %{prichozi/striz/}
	 {zdrojaky/robust/obr1/}
	 {zdrojaky/robust/obr2/}
	 {zdrojaky/fidlerova/obr/}
	 {zdrojaky/striz/obr/}
	 {zdrojaky/striz/tux/}	 
   }
...
\ifnum\cislo=4
  %\zpravy
  %\vloz{clenska-schuze/vize}{czech}
  %\vloz{clenska-schuze/schuze}{czech}
  \vedecke
  %\vloz{praskova/praskova}{czech}
  %\vloz{vencalekfurstova/vencalekfurstova}{czech}  
  %\pozvanky
	%\vloz{mosna/mosna-OPRAVENE1}{czech}
\vloz{skalska/skalska}{czech}
\vloz{striz/striz}{czech}
	\zpravy
\vloz{fidlerova/fidlerova}{slovak}	
\vloz{robust/robust}{czech}
	%\zpravy
	%\vloz{ssds/ssds}{czech}
	%\vloz{robust/robust}{czech}
  %\vloz{vozar/vozar}{czech}
  %\vloz{cess2020/cess2020}{english}
  %\vloz{clenska-schuze/stakan}{czech}
  %\vloz{clenska-schuze/ml}{czech}
  %\vloz{rezanka2/rezanka2}{czech}
  %\vloz{rezanka1/rezanka1}{czech}
  %\vloz{redakce/redakce}{czech}
  %\def\vlozstranu{}  \vskip1cm
  %\vloz{3-rehak/3-rehak}{czech}
  %\vloz{2-tvrdik/2-tvrdik}{czech}
  %\vloz{1-uvodnik/1-uvodnik}{czech}  
  %\def\vlozstranu{}  \vskip1cm
  %\vloz{6-konference/6-konference}{czech}
  \fi
\closeme

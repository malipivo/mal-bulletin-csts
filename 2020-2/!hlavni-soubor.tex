...
\hypersetup{
  ...
  pdftitle={Informační bulletin České statistické společnosti, \the\cislo/\mezivypb},
...
%\vloz{striz-manim/striz-manim}{czech}
\zpravy
\vloz{vencalek/vencalek}{czech}
\vloz{striz-matika/striz-matika}{czech}
\fi
\closeme
...
\IfFileExists{obalka/obalka.pdf}{%
%, přední strana obálky
\newpage
\thispagestyle{empty}
\begin{tikzpicture}[remember picture, overlay]
\node at (current page) {\includegraphics[viewport=449 27.5 870.263 623.691, width=\paperwidth, height=\paperheight]{obalka/obalka.pdf}};
\end{tikzpicture}
%\addtocounter{page}{-1}
...
\thispagestyle{empty}
\begin{tikzpicture}[remember picture, overlay]
\node at (current page) {\includegraphics[viewport=28.371 27.5 449.25 623.691, width=\paperwidth, height=\paperheight]{obalka/obalka.pdf}};
